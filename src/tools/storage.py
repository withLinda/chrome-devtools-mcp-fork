...
def register_storage_tools(mcp: FastMCP) -> None:
    ...
    @mcp.tool()
    @require_cdp_client
    async def get_storage_usage_and_quota(cdp_client, origin: str) -> dict[str, Any]:
        """
    ...
    @mcp.tool()
    @require_cdp_client
    async def get_all_cookies(cdp_client) -> dict[str, Any]:
        """
    ...
    @mcp.tool()
    @require_cdp_client
    async def clear_all_cookies(cdp_client) -> dict[str, Any]:
        """
    ...
    @mcp.tool()
    @require_cdp_client
    async def get_storage_key_for_frame(cdp_client, frame_id: str) -> dict[str, Any]:
        """
    ...
    @mcp.tool()
    @require_cdp_client
    async def track_cache_storage(cdp_client, origin: str, enable: bool = True) -> dict[str, Any]:
        """
    ...
    @mcp.tool()
    @require_cdp_client
    async def track_indexeddb(cdp_client, origin: str, enable: bool = True) -> dict[str, Any]:
        """
    ...
    async def override_storage_quota(
        cdp_client, origin: str, quota_size_mb: float | None = None
    ) -> dict[str, Any]:
        """
