...
This module implements the core ChromeDevToolsClient class and initialises all
tool registrations. It handles WebSocket communication with Chrome instances,
event processing, and command execution through the CDP interface.
